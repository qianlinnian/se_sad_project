...
<p align="center">
  <img src="diagrams/CampusCardInteractionDiagram.png" alt="Campus Card Recharge Main Interaction Flow" style="width:80%; max-width:800px; height:auto;"/>
</p>
...
| --------------------- | ----- |------- |
| Feng Juncai  2353924  | 1. Designed the class diagram and sequence interaction diagram for the meal order part.<br>2. Updated the use cases for meal order.<br>3. Updated the system snapshots for meal order and annotated the core functionalities.<br>4. Considered open issues.  |    25%    |
| Ji Peng  2351869      | 1. Write and improve the use case diagram, use case protocol and activity diagram of the campus card recharge part<br>2. Design the class/module structure of the campus card recharge part and draw the class diagram<br>3. Design a snapshot of the campus card recharge part according to the function<br>4. Collect and investigate references  |    25%    |
| Zhang Shikou  2353240 | 1.Analyze and refine the use case diagram, use case specifications, and interaction diagram for the Feedback subsystem.<br>2.Design the class/module structure for the Feedback subsystem and illustrate it with a class diagram.<br>3.Create system snapshots for the Feedback subsystem that demonstrate its key functionalities.<br>4.Collect and investigate relevant references and literature.  |    25%    |
| Yu Yilian  2352993    | 1. Complete the review section for student comments and dish recommendations.<br>2. Revise the corresponding use case diagram and use case descriptions.<br>3. Assist in checking minor details in the documentation.  |    25%    |
